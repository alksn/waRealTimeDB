<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormFind.aspx.cs" Inherits="waRealTimeDB.WebFormFind" %>
          ...
          <tr>
              <td>
                    <div class="row" style="margin-bottom: 0.5rem; margin-top: 0.7rem;">
                        ...
                        <div class="col-8" style="padding: 0;"><asp:TextBox ID="TextBoxFind2" style="border-radius: 0.5rem; width: 100%; padding: .3rem .75rem;" class="form-control" placeholder="Find Name" runat="server"></asp:TextBox></div>
                    </div>
              </td>
              <td></td>
          </tr>
		  ...
		  <tr>
            ...
            <asp:GridView class="table table-striped table-bordered table-find-filter" style="line-height: 1;" ID="GridViewStores" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSourceStore">
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-CssClass="ip110link" HeaderStyle-CssClass="ip110link" HeaderText="IP">
                        <ItemTemplate>
