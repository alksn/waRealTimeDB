...
{
    public partial class WebFormFind : System.Web.UI.Page
    {
        ...
        {
            LabelAppName.Text = "Dominos restaurant find";
            ...
            */
            ...
            mainDefaultSqlText =
                ...
                "select ip110, ip, Id, Code, name, newsName, ord, publishingTime from " +
                "(" +
                "select ip, STUFF(st.ip, PATINDEX('%.2', st.ip), 2, '.110') ip110, st.Id, st.Code, st.Name2 name, head1.Name newsName, head1.ord, head1.publishingTime from Store st " +
